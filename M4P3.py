...
print(f"With 18% Tip:")
print(f"    Total: " .ljust(20),"${:5.2f}".rjust(10).format(meal_total))
print(f"    Tip:" .ljust(20),"${:5.2f}".rjust(10).format(eighteen_tip))
print(f"    Total with tip:".ljust(20),"${:5.2f}".rjust(10).format(eighteen_total))
print(f"With 20% Tip:")
print(f"    Total: ".ljust(20),"${:5.2f}".rjust(10).format(meal_total))
print(f"    Tip:".ljust(20),"${:5.2f}".rjust(10).format(twenty_tip))
print(f"    Total with tip:" .ljust(20),"${:5.2f}".rjust(10).format(twenty_total))
